...
class FilamentTrumbowygServiceProvider extends PackageServiceProvider
{
    ...
    public function packageBooted(): void
    {
        FilamentAsset::register([
            // Styles
            Css::make('trumbowyg-core', 'https://cdnjs.cloudflare.com/ajax/libs/Trumbowyg/2.27.3/ui/trumbowyg.min.css'),

            // Scripts
            Js::make('jquery', 'https://code.jquery.com/jquery-3.6.1.min.js'),
            Js::make('trumbowyg-core', 'https://cdnjs.cloudflare.com/ajax/libs/Trumbowyg/2.27.3/trumbowyg.min.js'),
